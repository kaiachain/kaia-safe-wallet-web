...
export const ContentSecurityPolicy = `
 default-src 'self';
 connect-src 'self' *;
 script-src 'self' https://www.google-analytics.com https://ssl.google-analytics.com https://noteforms.com 'unsafe-inline' https://www.googletagmanager.com https://*.ingest.sentry.io https://sentry.io ${
